  ...
  <section id="wsus__dashboard">
    ...
    @include('vendor.layouts.sidebar')
      <div class="row">
        ...
        <a href="{{route('vendor.products-variant.index', ['product' => $variant->product_id])}}" class="btn btn-warning mb-2"><i class="fas fa-angle-double-left"></i> Back</a>
          <div class="dashboard_content mt-2 mt-md-0">
            <h3><i class="far fa-user"></i>Edit variants</h3>
