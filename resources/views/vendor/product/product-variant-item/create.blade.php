  ...
  <section id="wsus__dashboard">
    ...
    @include('vendor.layouts.sidebar')
      <div class="row">
        ...
        <a href="{{route('vendor.products-variant-item.index', ['productId' => $product->id, 'variantId' => $variant->id])}}" class="btn btn-warning mb-2"><i class="fas fa-angle-double-left"></i> Back</a>
