...
<div class="tab-pane fade" id="list-banner-3" role="tabpanel" aria-labelledby="list-banner-3-list">
    <div class="card border">
        <div class="card-body">
            <form action="{{route('admin.advertisement.homepage-banner-three')}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="form-group">
                    <img src="{{ asset(@$homepage_section_banner_three->banner_one->banner_image) }}" alt="banner_one" width="150px">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <img src="{{ asset(@$homepage_section_banner_three->banner_two->banner_image) }}" alt="banner_two" width="150px">
                </div>
                <div class="form-group">
                    <label>Banner Image</label>
                ...
                <div class="form-group">
                    <img src="{{ asset(@$homepage_section_banner_three->banner_three->banner_image) }}" alt="banner_three" width="150px">
                </div>
                <div class="form-group">
                    <label>Banner Image</label>
