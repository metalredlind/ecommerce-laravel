<div class="tab-pane fade show active" id="list-banner-1" role="tabpanel" aria-labelledby="list-banner-1-list">
    <div class="card border">
        <div class="card-body">
            <form action="{{route('admin.advertisement.homepage-banner-one')}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="form-group">
                    <img src="{{ asset($homepage_section_banner_one->banner_one->banner_image) }}" alt="banner_one" width="150px">
                </div>
                <div class="form-group">
