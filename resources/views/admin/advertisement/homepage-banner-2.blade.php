...
<div class="tab-pane fade" id="list-banner-2" role="tabpanel" aria-labelledby="list-banner-2-list">
    <div class="card border">
        <div class="card-body">
            <form action="{{route('admin.advertisement.homepage-banner-two')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <img src="{{ asset(@$homepage_section_banner_two->banner_one->banner_image) }}" alt="banner_one" width="150px">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <img src="{{ asset(@$homepage_section_banner_two->banner_two->banner_image) }}" alt="banner_two" width="150px">
                </div>
                <div class="form-group">
                    <label>Banner Image</label>
