                    ...
                    <div class="wsus__pro_page_bammer vendor_det_banner">
                        ...
                        <div class="wsus__pro_page_bammer_text wsus__vendor_det_banner_text">
                            <div class="wsus__vendor_text_center">
                                ...
                                <a href="callto:{{$vendor->name}}"><i class="far fa-phone-alt"></i> {{$vendor->phone}}</a>
                                <a href="mailto:{{$vendor->email}}"><i class="far fa-envelope"></i> {{$vendor->email}}</a>
                                <p class="wsus__vendor_location"><i class="fal fa-map-marker-alt"></i> {{$vendor->address}} (US) </p>
                                <ul class="d-flex">
                                ...
                                <div class="wsus__product_topbar_left">
                                    <div class="nav nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                        <button
                                            ...
                                            id="v-pills-home-tab" data-id="grid" data-bs-toggle="pill"
                                        ...
                                        <button
                                            ...
                                            id="v-pills-profile-tab" data-id="list" data-bs-toggle="pill"
