...
class UserVendorRequestController extends Controller
{
    ...
    {
        $termCondition = VendorCondition::first();
        return view('frontend.dashboard.vendor-request.index', compact('termCondition'));
    }
    ...
    public function create(Request $request)
    {
        ...
        toastr('Vendor Request Submitted. Wait for approval.','success','Success');
