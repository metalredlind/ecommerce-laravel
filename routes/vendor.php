...
Route::get('products-variant-item-edit/{variantItemId}/edit', [VendorProductVariantItemController::class, 'edit'])->name('products-variant-item.edit');
Route::put('products-variant-item-update/{variantItemId}/edit', [VendorProductVariantItemController::class, 'update'])->name('products-variant-item.update');
...
Route::get('orders/status/{id}', [VendorOrderController::class, 'status'])->name('orders.status');

//reviews route
Route::get('reviews', [VendorProductReviewController::class, 'index'])->name('reviews.status');